...
export default function Users() {
    ...
    // render() {
        ...
        const data2 = [
            ...
            [country[1].label, userInfo.map(state => (Object.entries(state.AP.delta7)) ? Object.entries(state.AP.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.AP.delta7)) ? Object.entries(state.AP.delta7)[4][1] : 0 )[0]],
            [country[2].label, userInfo.map(state => (Object.entries(state.AR.delta7)) ? Object.entries(state.AR.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.AR.delta7)) ? Object.entries(state.AR.delta7)[4][1] : 0 )[0]],
            [country[3].label, userInfo.map(state => (Object.entries(state.AS.delta7)) ? Object.entries(state.AS.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.AS.delta7)) ? Object.entries(state.AS.delta7)[4][1] : 0 )[0]],
            [country[4].label, userInfo.map(state => (Object.entries(state.BR.delta7)) ? Object.entries(state.BR.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.BR.delta7)) ? Object.entries(state.BR.delta7)[4][1] : 0 )[0]],
            [country[5].label, userInfo.map(state => (Object.entries(state.CH.delta7)) ? Object.entries(state.CH.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.CH.delta7)) ? Object.entries(state.CH.delta7)[4][1] : 0 )[0]],
            [country[6].label, userInfo.map(state => (Object.entries(state.CT.delta7)) ? Object.entries(state.CT.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.CT.delta7)) ? Object.entries(state.CT.delta7)[4][1] : 0 )[0]],
            [country[7].label, userInfo.map(state => (Object.entries(state.DL.delta7)) ? Object.entries(state.DL.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.DL.delta7)) ? Object.entries(state.DL.delta7)[4][1] : 0 )[0]],
            ...
            [country[9].label, userInfo.map(state => (Object.entries(state.GA.delta7)) ? Object.entries(state.GA.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.GA.delta7)) ? Object.entries(state.GA.delta7)[4][1] : 0 )[0]],
            [country[10].label, userInfo.map(state => (Object.entries(state.GJ.delta7)) ? Object.entries(state.GJ.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.GJ.delta7)) ? Object.entries(state.GJ.delta7)[4][1] : 0 )[0]],
            [country[11].label, userInfo.map(state => (Object.entries(state.HP.delta7)) ? Object.entries(state.HP.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.HP.delta7)) ? Object.entries(state.HP.delta7)[4][1] : 0 )[0]],
            [country[12].label, userInfo.map(state => (Object.entries(state.GA.delta7)) ? Object.entries(state.HR.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.HR.delta7)) ? Object.entries(state.HR.delta7)[4][1] : 0 )[0]],
            [country[13].label, userInfo.map(state => (Object.entries(state.JH.delta7)) ? Object.entries(state.JH.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.JH.delta7)) ? Object.entries(state.JH.delta7)[4][1] : 0 )[0]],
            [country[14].label, userInfo.map(state => (Object.entries(state.JK.delta7)) ? Object.entries(state.JK.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.JK.delta7)) ? Object.entries(state.JK.delta7)[4][1] : 0 )[0]],
            [country[15].label, userInfo.map(state => (Object.entries(state.KA.delta7)) ? Object.entries(state.KA.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.KA.delta7)) ? Object.entries(state.KA.delta7)[4][1] : 0 )[0]],
            [country[16].label, userInfo.map(state => (Object.entries(state.KL.delta7)) ? Object.entries(state.KL.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.KL.delta7)) ? Object.entries(state.KL.delta7)[4][1] : 0 )[0]],
            [country[17].label, userInfo.map(state => (Object.entries(state.LD.delta7)) ? Object.entries(state.LD.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.LD.delta7)) ? Object.entries(state.LD.delta7)[4][1] : 0 )[0]],
            [country[18].label, userInfo.map(state => (Object.entries(state.MH.delta7)) ? Object.entries(state.MH.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.MH.delta7)) ? Object.entries(state.MH.delta7)[4][1] : 0 )[0]],
            [country[19].label, userInfo.map(state => (Object.entries(state.ML.delta7)) ? Object.entries(state.ML.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.ML.delta7)) ? Object.entries(state.ML.delta7)[4][1] : 0 )[0]],
            [country[20].label, userInfo.map(state => (Object.entries(state.MN.delta7)) ? Object.entries(state.MN.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.MN.delta7)) ? Object.entries(state.MN.delta7)[4][1] : 0 )[0]],
            [country[21].label, userInfo.map(state => (Object.entries(state.MP.delta7)) ? Object.entries(state.MP.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.MP.delta7)) ? Object.entries(state.MP.delta7)[4][1] : 0 )[0]],
            [country[22].label, userInfo.map(state => (Object.entries(state.MZ.delta7)) ? Object.entries(state.MZ.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.MZ.delta7)) ? Object.entries(state.MZ.delta7)[4][1] : 0 )[0]],
            [country[23].label, userInfo.map(state => (Object.entries(state.NL.delta7)) ? Object.entries(state.NL.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.NL.delta7)) ? Object.entries(state.NL.delta7)[4][1] : 0 )[0]],
            [country[24].label, userInfo.map(state => (Object.entries(state.OR.delta7)) ? Object.entries(state.OR.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.OR.delta7)) ? Object.entries(state.OR.delta7)[4][1] : 0 )[0]],
            [country[25].label, userInfo.map(state => (Object.entries(state.PB.delta7)) ? Object.entries(state.PB.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.PB.delta7)) ? Object.entries(state.PB.delta7)[4][1] : 0 )[0]],
            [country[26].label, userInfo.map(state => (Object.entries(state.PY.delta7)) ? Object.entries(state.PY.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.PY.delta7)) ? Object.entries(state.PY.delta7)[4][1] : 0 )[0]],
            [country[27].label, userInfo.map(state => (Object.entries(state.RJ.delta7)) ? Object.entries(state.RJ.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.RJ.delta7)) ? Object.entries(state.RJ.delta7)[4][1] : 0 )[0]],
            [country[28].label, userInfo.map(state => (Object.entries(state.SK.delta7)) ? Object.entries(state.SK.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.SK.delta7)) ? Object.entries(state.SK.delta7)[4][1] : 0 )[0]],
            [country[29].label, userInfo.map(state => (Object.entries(state.TG.delta7)) ? Object.entries(state.TG.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.TG.delta7)) ? Object.entries(state.TG.delta7)[4][1] : 0 )[0]],
            [country[30].label, userInfo.map(state => (Object.entries(state.TN.delta7)) ? Object.entries(state.TN.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.TN.delta7)) ? Object.entries(state.TN.delta7)[4][1] : 0 )[0]],
            [country[31].label, userInfo.map(state => (Object.entries(state.TR.delta7)) ? Object.entries(state.TR.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.TR.delta7)) ? Object.entries(state.TR.delta7)[4][1] : 0 )[0]],
            ...
            [country[33].label, userInfo.map(state => (Object.entries(state.UP.delta7)) ? Object.entries(state.UP.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.UP.delta7)) ? Object.entries(state.UP.delta7)[4][1] : 0 )[0]],
            [country[34].label, userInfo.map(state => (Object.entries(state.UT.delta7)) ? Object.entries(state.UT.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.UT.delta7)) ? Object.entries(state.UT.delta7)[4][1] : 0 )[0]],
            [country[35].label, userInfo.map(state => (Object.entries(state.WB.delta7)) ? Object.entries(state.WB.delta7)[3][1] : 0 )[0],  userInfo.map(state => (Object.entries(state.WB.delta7)) ? Object.entries(state.WB.delta7)[4][1] : 0 )[0]],
            ...
            <div className="text-center col-md-10 " id="maincon">
                <div className=" d-flex pl-5 pr-5  justify-content-center justify-content-between inline-block mt-5 mb-5" >
                    <form >
                        ...
                        <form >
                        <h5> Tested</h5>
                         <h2>{userInfo.map(state =>(state.TT.delta.tested)? state.TT.delta.tested : "N/A") }</h2> 
                        </form>
                        <form  >
                        <h5> Confirmed</h5>
                        <h2>{userInfo.map(state =>state.TT.delta.confirmed) }</h2>

                        </form>
                        
                        <form >
                        <h5> Recovered</h5>
                        <h2> {userInfo.map(state =>state.TT.delta.recovered) }</h2>
             ...
             <h2 className="mb-5">Graphical Representation</h2>
                ...
                :
                   ...
                   <Chart
                    ...
                    data={data2}
                    options={{
                        title: 'Vaccination Doses (Weekly)',
                        chartArea: { width: '50%' },
                        hAxis: {
                        title: 'Vaccine Doses',
                        minValue: 0,
